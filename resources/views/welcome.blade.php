...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="index.html">Narasi Sejarah</a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container d-flex flex-column align-items-center" data-aos="zoom-in" data-aos-delay="100">
      <h1>Narasi Sejarah</h1>
      <p>Website akan memberikan Anda pengetahuan lebih dalam mengenai sejarah Kesultanan Banjar</p>
      <a href=" {{ route('login')}}" class="btn-about">Masuk/Daftar</a>
    </div>
  </section><!-- End Hero -->
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Narasi  <strong><span>Sejarah</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
